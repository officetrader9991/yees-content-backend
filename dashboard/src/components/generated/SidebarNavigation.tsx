      ...
      duration: 0.3
        ...
        <div className="flex-1 py-6">
          ...
          <div className="mt-8 px-3">
            <h2 className={cn("px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider", collapsed && "text-center")}>
              {collapsed ? "T" : "Tools"}
            </h2>
          ...
          <div className="mt-2 flex flex-col gap-3 px-3" aria-label="Sidebar Actions">
            ...
            <button type="button" onClick={() => handleNavigation("voiceover")} className="flex items-center gap-3 rounded-xl px-4 py-3 bg-gradient-to-r from-green-100 to-green-50 hover:from-green-200 hover:to-green-100 text-green-800 font-semibold shadow-sm border border-green-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2" aria-label="Growth Insights" tabIndex={0}>
              ...
              {!collapsed && <span className="truncate">Voiceover</span>}
            </button>
            <button type="button" onClick={() => handleNavigation("translator")} className="flex items-center gap-3 rounded-xl px-4 py-3 bg-gradient-to-r from-indigo-100 to-indigo-50 hover:from-indigo-200 hover:to-indigo-100 text-indigo-800 font-semibold shadow-sm border border-indigo-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2" aria-label="Translator" tabIndex={0}>
              <Languages className="w-5 h-5 text-indigo-500" />
              {!collapsed && <span className="truncate">Translator</span>}
            </button>
          </div>
        </div>
